...
\datadefesa{\uppercase{20 de dezembro de 2014}}
...
\begin{figure}[htb]
	\begin{center}
		...
		\fonte{IPROCESS}\label{fig-bpmn-exemplo}
	\end{center}
\end{figure}
...
\begin{figure}[htb]
	\begin{center}
		...
		\fonte{BALDAM (2008)}\label{fig-processo}
	\end{center}
\end{figure}
...
\begin{figure}[htb]
	\begin{center}
		...
		\fonte{ERIKSSON; PENKER; (2000)}\label{fig-macroprocesso}
	\end{center}
\end{figure}
